      ...
      if(mlineseg[i].yn == OUTPUT &&
         (mlineseg[i].xs != mlineseg[i].xe
          ...
          fprintf(ofp,"%d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
            ...
            mcc[mlineseg[i].lab1].y_min,
            mcc[mlineseg[i].lab1].y_max,
            mcc[mlineseg[i].lab2].x_min,
            mcc[mlineseg[i].lab2].x_max,
            mcc[mlineseg[i].lab2].y_min,
            mcc[mlineseg[i].lab2].y_max,
            mlineseg[i].lab1,
            mlineseg[i].lab2
            );
      }
